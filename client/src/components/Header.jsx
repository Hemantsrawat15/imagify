...
function Header() {
  return (
    <div className="flex flex-col justify-center items-center text-center my-20">
      <div className="text-stone-500 inline-flex text-center gap-2 bg0white px-6 py-1 rounded-full border border-neutral-500">
      ...
      <div className="flex flex-wrap justify-center mt-16 gap-3">
        {Array(6)
          ...
          .map((item, index) => (
            <img
              className="rounded hover:scale-105 transition-all duraton-300 cursor-pointer max-sm:w-10"
              key={index}
              width={80}
